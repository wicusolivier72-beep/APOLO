        ...
        {filteredMyths.map((myth) => (
          <div key={myth.id} className="blueprint-card border border-[#222630] bg-[#13151A] p-5 rounded-xl">
            <div className="flex items-center justify-between border-b border-[#222630] pb-3 mb-4">
              ...
              <span className="text-xs text-[#9CA3AF]">{myth.id}</span>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-12 gap-5 mb-4 text-sm">
              <div className="md:col-span-5 p-4 bg-[#0B0C0E] border border-[#222630] rounded-xl">
                <div className="text-xs text-[#9CA3AF] font-medium mb-1">Viral Claim:</div>
                <h4 className="text-base font-semibold text-[#F3F4F6] mb-2">"{myth.claim}"</h4>
                <p className="text-sm text-[#9CA3AF] leading-relaxed">{myth.mythDetail}</p>
              </div>

              <div className="md:col-span-7 p-4 bg-[#0B0C0E] border border-[#222630] rounded-xl flex flex-col justify-between">
                <div>
                  <div className="text-xs text-[#E2C08D] font-semibold mb-1">Historical Reality:</div>
                  <p className="text-sm text-[#F3F4F6] leading-relaxed mb-3">{myth.historicalReality}</p>
                </div>
                <div className="text-sm text-[#E2C08D] pt-2 border-t border-[#222630]">
            ...
            <div className="p-3.5 bg-[#0B0C0E] border border-[#222630] rounded-lg text-sm">
              <div className="text-xs text-[#9CA3AF] font-semibold mb-1.5">30-Second Takeaway:</div>
