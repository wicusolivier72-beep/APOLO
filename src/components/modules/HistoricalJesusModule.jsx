    ...
    <div className="space-y-8">
      ...
      <div className="blueprint-card p-6 sm:p-7 border border-[#222630] bg-[#13151A] rounded-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[#222630] pb-4 mb-6">
          ...
          <span className="text-sm text-[#9CA3AF] mt-1 sm:mt-0">Early Jerusalem Oral Tradition (c. 33 AD)</span>
        </div>
        ...
        <div className="mt-6 p-4 sm:p-5 bg-[#0B0C0E] border border-[#222630] rounded-xl text-sm text-[#9CA3AF] leading-relaxed">
          <span className="text-[#E2C08D] font-semibold">Historical Takeaway: </span>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {nonChristianHistorians.map((h, i) => (
            <div key={i} className="blueprint-card p-6 border border-[#222630] bg-[#13151A] rounded-xl flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-3">
                  <span className="subtle-badge">Extra-Biblical</span>
                  <span className="text-xs text-[#9CA3AF]">{h.historian.split(' ')[0]}</span>
                </div>

                <h4 className="text-lg font-semibold text-[#F3F4F6] mb-1">{h.historian}</h4>
                <div className="text-sm text-[#E2C08D] font-medium mb-4">{h.work}</div>

                <blockquote className="p-4 bg-[#0B0C0E] border-l-2 border-l-[#E2C08D] text-sm text-[#F3F4F6] italic mb-4 leading-relaxed rounded-r-lg">
                  "{h.quote}"
                </blockquote>

                <p className="text-sm text-[#9CA3AF] leading-relaxed">{h.significance}</p>
              </div>

              <div className="pt-4 border-t border-[#222630] mt-4 flex items-center justify-between text-sm">
